...
inc_map_may_2020 <- ggplot() +
  ...
  geom_point(data = pi_may_2020, aes(x=pi_may_2020$Longitude, y=pi_may_2020$Latitude, color="red"))
...
p1_may_map <- ggplot() +
  geom_sf(data = censusDataShp, aes()) +
  geom_point(data = pi_type1_crimes_2020, aes(x=pi_type1_crimes_2020$Longitude, y=pi_type1_crimes_2020$Latitude, color="red"))
