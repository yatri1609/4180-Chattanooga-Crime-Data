...
plot(x[1:82], border = "black", color = 'blue', xlab = "Month", ylab = 'Number of incidents' )

```    

```{r}
## Plot Incidents Per Month:
y<- incidence(police_incident$Date_Incident, interval = "1 year")

plot(y[1:length(y)], border = "black", color = 'blue', xlab = "Year", ylab = 'Number of incidents' )
```
