...
pi_july_2020 <-  police_incident[police_incident$Date_Incident >= "2020-07-01" & police_incident$Date_Incident <= "2020-07-31",]
...
```{r}
## Make leaflet plot for police incidents in the month of 2020 with the highest crime (July 17')
inc_map_july_2020 <- leaflet(pi_july_2020) %>%
  addTiles() %>% addMarkers()
...
```{r}
##Refine DataFrame to show only part one crimes in july 2020
pi_type1_crimes_2020 <- pi_july_2020 %>% filter(pi_july_2020$Incident_Type == "Part 1 Crimes")

```

```{r}
## Make leaflet plot for part one police incidents in the month of July in 2020
p1_july_map <- leaflet(pi_type1_crimes_2020) %>%
  addTiles() %>% addMarkers()
...
```{r}
##Refine DataFrame to show only robbery crimes in july 2020
p1_Crimes_july_2020_robbery <- pi_july_2020 %>% filter(pi_july_2020$Incident_Description == "Robbery")

head(p1_Crimes_july_2020_robbery)

```

```{r}
## Make leaflet plot for part one police incidents (robberies) in the month of July in 2020
p1_july_map_robbery <- leaflet(p1_Crimes_july_2020_robbery) %>%
  addTiles() %>% addMarkers()
